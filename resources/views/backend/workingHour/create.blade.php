...
@section('site_name', 'Çalışma Saati')
@section('css')
@endsection
@section('content')
        ...
        <div class="row g-4">
            ...
            <div class="col-sm-12 col-xl-12">
                <div class="bg-light rounded h-100 p-4">
                    ...
                    <form action="{{ route('admin.workingHour.store') }}" method="POST"  enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-3">
                            <label for="inputEmail3" class="col-sm-3 col-form-label">Çalışma Saati Gün</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="day" placeholder="Pazartesi">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="inputEmail3" class="col-sm-3 col-form-label">Çalışma Saati</label>
                            <div class="col-sm-6 " id="dynamic_field">
                                <input type="text" class="form-control" name="hour[]" placeholder="09.00-10.00">
                            </div>
                            <div class="col-sm-3">
