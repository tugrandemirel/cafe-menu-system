...
@section('site_name', $product->name.' - Düzenle')
@section('css')
            ...
            <div class="col-sm-12 col-xl-12">
                <div class="bg-light rounded h-100 p-4">
                    ...
                    <form action="{{ route('admin.product.update', ['product'=>$product->id]) }}" method="POST"  enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <label for="" class="form-label col-sm-3">Ürün Adı</label>
                            <div class="col-sm-9">
                                <input type="text" class="form-control" name="name" value="{{ $product->name }}">
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <img src="{{ asset($product->image) }}" class="img-thumbnail" width="100">
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row mb-3">
                            ...
                            <textarea name="description" class="form-control" id="" cols="30" rows="1">{{ $product->description }}</textarea>
                        </div>
                        <div class="row mb-3">
                            <div class="col-md-6">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-11">
                                <div class="form-check">
                                    <input class="form-check-input" name="status" type="checkbox" {{ $product->status===1 ? 'checked' :'' }} id="gridCheck1">
                                </div>
                            </div>
                        </div>
